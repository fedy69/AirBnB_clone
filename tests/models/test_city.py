#!/usr/bin/python3
"""
File that Contains the TestCityDocs classes
"""
...
class TestCityDocs(unittest.TestCase):
    """The tests to check the documentation and style of City class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_test_city(self):
        """The test that tests/test_models/test_city.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_city_module_docstring(self):
        """The test for the city.py module docstring"""
    ...
    def test_city_func_docstrings(self):
        """The test for the presence of docstrings in City methods"""
...
class TestCity(unittest.TestCase):
    ...
    def test_name_attr(self):
        """The test that City has attribute name, and it's an empty string"""
        city = City()
        self.assertTrue(hasattr(city, "name"))
        self.assertEqual(city.name, "")

    def test_state_id_attr(self):
        """The test that City has attribute state_id, and it's an empty string"""
        city = City()
