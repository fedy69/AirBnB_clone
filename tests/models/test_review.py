#!/usr/bin/python3
"""
File that contains the TestReviewDocs classes
"""
...
class TestReviewDocs(unittest.TestCase):
    """The tests to check the documentation and style of Review class"""
    @classmethod
    def setUpClass(cls):
    ...
    def test_pep8_conformance_test_review(self):
        """the test that tests/test_models/test_review.py conforms to PEP8."""
        pep8s = pep8.StyleGuide(quiet=True)
    ...
    def test_review_module_docstring(self):
        """The test for the review.py module docstring"""
    ...
    def test_review_class_docstring(self):
        """The test for the Review class docstring"""
        self.assertIsNot(Review.__doc__, None,
    ...
    def test_review_func_docstrings(self):
        """The test for the presence of docstrings in Review methods"""
...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        """The test Review has attr place_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "place_id"))
        self.assertEqual(review.place_id, "")

    def test_user_id_attr(self):
        """The test Review has attr user_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "user_id"))
        self.assertEqual(review.user_id, "")

    def test_text_attr(self):
        """The test Review has attr text, and it's an empty string"""
        review = Review()
